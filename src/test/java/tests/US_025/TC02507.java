...
public class TC02507 extends TestBaseRapor {
    ...
    public void test01() {
        {
            ...
            //INVENTORY kismina gecildi
            extentTest.info("inventory kismina giris yapildi");
            ...
            WebElement artiTusu = Driver.getDriver().findElement(By.xpath("//i[@class='zmdi zmdi-plus-circle-o']"));
            artiTusu.click();
