...
public class TC02905 extends TestBaseRapor {
    ...
    public void test01() {
        ...
        extentTest = extentReports.createTest("Tamamlanan siparisin ozet bilgileri yazdirilabilir olmalidir", "Tamamlanan siparisin ozet bilgileri yazdirilabilme testi yapildi");
    ...
    public void test02() {
        ...
        merchantOrders.completedUcNoktaButonu.click();
        extentTest.info("Uc nokta tusuna tiklanir");
        ReusableMethods.bekle(2);
        merchantOrders.completedContactCustomer.click();
        ReusableMethods.bekle(2);
        extentTest.info("Contact customer bolumune tiklanir");
        WebElement completedOkay= Driver.getDriver().findElement(By.xpath("//button[text()='Okay']"));
        completedOkay.click();
    ...
    public void test04() {
        ...
        ReusableMethods.bekle(2);
        extentTest.info("Uc nokta tusuna tiklanir");
        merchantOrders.completedDownloadPDF.click();
