...
public class TC02706 extends TestBaseRapor {
...
//Soyisim ile siparisler arasında filtrleme yapabilir oldugu dogrulanmalidir
    ...
    public void test01() {
        ...
        extentTest = extentReports.createTest("Kabul edilen siparisin isim ile filtrelenebilir oldugu dogrulanmalidir", "Pozitif kabul edilen siparisin isim ile filtrelenebilme  testi yapildi");
